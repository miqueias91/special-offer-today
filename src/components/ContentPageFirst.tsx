interface ContentPageFirstProps {
    titleProduct: string
    linkProduct: string
}

export default function ContentPageFirst({
    titleProduct,
    linkProduct,
  }: ContentPageFirstProps) {
  return (
    ...
    <footer className="bg-gray-900 ">
      <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">{titleProduct}™</a>. All Rights Reserved.
        </span>
